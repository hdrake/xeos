...
@pytest.mark.parametrize("model,selector,expected", [
    ...
    # MOM6's "UNESCO"/"JACKETT_MCD" is the Jackett & McDougall (1995) fit (= jmd95),
    # not the EOS-80 `unesco` that MITgcm's "UNESCO" selects. See models.py.
    ("MOM6", "UNESCO", "jmd95"),
    ("MOM6", "JACKETT_MCD", "jmd95"),
    ("MOM6", "ROQUET_SPV", "roquet-spv"),
    ("MITgcm", "JMD95Z", "jmd95"),
    ("MITgcm", "JMD95P", "jmd95"),
    ("MITgcm", "UNESCO", "unesco"),
    ("MITgcm", "MDJWF", "mdjwf"),
    ("MPAS", "linear", "mpas-linear"),
    ("MPAS", "jm", "mpas-jm"),
    ("MPAS", "wright", "mpas-wright"),
    ("MPAS-Ocean", "jm", "mpas-jm"),
